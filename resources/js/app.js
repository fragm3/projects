        ...
        return {
            ...
            controller: function ($scope, $location, Languages) {
                ...
                $scope.updateProjects = function () {
                    if ($scope.lang != 'en') {
                        $http.get('data/locale/'+$scope.lang+'/projects.json').then(function (res) {
                ...
                function generateMarkdown() {
                    ...
                    function setFromDefault() {
                        $http.get($scope.currentProject.content_url).then(function (res) {
        ...
        return {
            ...
            controller: function ($scope, Languages) {
                ...
                $scope.generateMarkdown = function() {
                    ...
                    function setFromDefault(key=null) {
                        if(key) {
